...
Managed Resource Group name (optional): an automatically created resource group where Azure provisions and manages the infrastructure resources needed for your Databricks workspace.
Tip
A Free Edition is available for students and educators with no time limit and no payment required, though it has daily usage limits and no access to classic compute. See [Sign up for Azure Databricks](https://learn.microsoft.com/en-us/azure/databricks/getting-started/free-trial-vs-free-edition) for a comparison.
If you decide to create an Azure Databricks deployment using the Azure CLI, this would be the [az databricks workspace](https://learn.microsoft.com/en-us/cli/azure/ext/databricks/databricks/workspace) command to remember:
...
[en-us](https://learn.microsoft.com/en-us/training/modules/explore-azure-databricks/02-azure-databricks)
